package com.pcgrw.mqdemo.rabbitmq.topic;
...
public class Receiver1 {
    ...
    public static final String QUEUE_TEST1 = "testtopqueue1";
    ...
    public static void main(String[] args) throws Exception {
        ...
        channel.queueBind(QUEUE_TEST1,EXCHANGE_NAME,"key.*");
        //如果要接收多个标记，只需要在执行一次即可
        channel.queueBind(QUEUE_TEST1,EXCHANGE_NAME,"abc.#");
        ...
        channel.basicConsume(QUEUE_TEST1, false, consumer);
    }
}
